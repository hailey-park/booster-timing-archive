...
noBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), "simulation-results/sensitivity/5-year-sim/noBooster-immuno-mean.csv")
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), "simulation-results/sensitivity/5-year-sim/1Booster-immuno-mean.csv")
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), paste0("simulation-results/sensitivity/5-year-sim/annualBooster-immuno-mean.csv"))
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), paste0("simulation-results/sensitivity/5-year-sim/biannualBooster-immuno-mean.csv"))
}
