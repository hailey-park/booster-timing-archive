...
noBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/main/noBooster-", age_info, "-mean.csv"))
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/main/1Booster-", age_info, "-mean.csv")) ####CHANGE HERE
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/main/annualBooster-", age_info, "-mean.csv")) ####CHANGE HERE
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/main/biannualBooster-", age_info, "-mean.csv")) ####CHANGE HERE
}
