...
noBoosterSimulation <- function(df){
  ...
  write.csv(input, "simulation-results/main/noBooster-immuno-mean.csv")
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(input, "simulation-results/main/1Booster-immuno-mean.csv")
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/main/annualBooster-immuno-mean.csv"))
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/main/biannualBooster-immuno-mean.csv"))
}
