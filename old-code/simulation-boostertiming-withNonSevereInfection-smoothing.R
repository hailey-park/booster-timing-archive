...
age_18_49 <- read.csv("calibration-results/final/main/adj-calibration-1mil-18-49 years-mean.csv")[,-1]
age_50_64 <-  read.csv("calibration-results/final/main/adj-calibration-1mil-50-64 years-mean.csv")[,-1]
age_65_74 <-  read.csv("calibration-results/final/main/adj-calibration-1mil-65-74 years-mean.csv")[,-1]
age_75_plus <-  read.csv("calibration-results/final/main/adj-calibration-1mil-75+ years-mean.csv")[,-1]
...
# clean_df %>% lapply(function(df){
#   print(paste0("Average Protection at Start: ", mean(df$ve_pred)))}
#   )
###########################################################################################
...
outcome_occurrence <- function(age, inf, time, lambda, perfect_immunity_counter, death_marker) {
  ...
  #print(paste0("PE: ", pe[36032]))
  #print(paste0("Lambda: ", lambda[36032]))
  severe_risk <- lambda * (1 - pe)
  #print(paste0("Severe Risk: ", severe_risk[36032]))
  #print(paste0("Average Protection: ", mean(pe)))
  #print(paste0("Average Severe Risk: ", mean(severe_risk)))
...
noBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/final/main/noBooster-", age_info, "-mean.csv"))
}
...
oneBoosterSimulation <- function(df){
  ...
  print(average_pe)
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/final/sensitivity/high-incidence/1Booster-", age_info, "-lower.csv"))
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/final/sensitivity/high-incidence/annualBooster-", age_info, "-lower.csv"))
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/final/sensitivity/high-incidence/biannualBooster-", age_info, "-lower.csv"))
}
